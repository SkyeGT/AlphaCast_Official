...
#     local_dir: str = "./alphacast/foundation_models/timesfm"
...
#     alias: str = "TimesFM"
#     # Fixed local model directory (must exist in the runtime environment)
#     local_dir: str = "/data/Forever_Pan/AGI_sources/data/xhzhang/cast/alphacast/alphacast/foundation_models/timesfm"
#     # Fixed HuggingFace repo ID for offline parsing
#     hf_repo_id: str = "google/timesfm-1.0-200m-pytorch"
#     context_len: int = 512
#     backend: Optional[str] = None
...
class ChronosModel:
    ...
    local_dir: Optional[str] = \
        "./alphacast/foundation_models/chronos-bolt-base"
...
# class SundialModel:
#     alias: str = "Sundial"
#     local_dir: Optional[str] = "./alphacast/foundation_models/sundial-base-128m"
